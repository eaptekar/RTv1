...
/*   Updated: 2018/09/19 20:56:13 by eaptekar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_plane		*add_plane(void)
{
	...
	plane[0] = init_plane(set_point(0, 0, 30), set_point(0, 0, 29));
	...
	plane[2] = init_plane(set_point(8, 0, 0), set_point(7, 0, 0));
	...
	plane[4] = init_plane(set_point(-8, 0, 0), set_point(-7, 0, 0));
...
static t_sphere		*add_sphere(void)
{
	...
	sphere[0] = init_sphere(set_point(4, -3, 15), 2);
	sphere[0] = parse_sphere(sphere[0], 1000, 0, 0xf2e71a);
	sphere[1] = init_sphere(set_point(1, -4, 12), 1);
...
static t_cylinder	*add_cylinder(void)
{
	...
	cylinder[0] = init_cylinder(set_point(1, -2, 22), set_point(4, -3, 21), 1);
...
static t_cone		*add_cone(void)
{
	...
	cone[0] = init_cone(set_point(-3, 0, 20), set_point(-3.1, -1, 19), 0.4);
